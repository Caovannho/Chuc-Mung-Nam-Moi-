...
const WISH_MESSAGES = [
	...
	"Năm mới, chúc hội mình ai cũng thành đại gia 💎",
	"Chúc anh em mãi keo, mãi mận, mãi bên nhau 🤝",
	"Năm mới bớt drama, thêm nhiều chuyến đi xa ✈️",
	"Chúc cả nhóm năm nay thoát ế thành công 💘",
	"Chúc mọi người ăn mãi không béo, ví lúc nào cũng dày 🍕",
	"Năm mới, chúc hội mình 'ngon' hơn năm ngoái 😎",
	"Chúc team mình sự nghiệp lên hương, lương tăng vù vù 🚀",
	"Năm mới, mục tiêu mới, cả nhóm cùng thành công 💪",
	"Chúc anh em chân cứng đá mềm, đánh đâu thắng đó 🏆",
	"Năm mới doanh số bùng nổ, thưởng tết ngập tràn 💰",
	"Chúc cả team sức khỏe dồi dào để chạy deadline không mệt mỏi ☕",
	"Chúc mọi người một năm rực rỡ, dự án nào cũng thành công 🌟",
	
	"Năm mới an khang thịnh vượng, 8386 mãi dỉnh! 🤙",

	
	"Chúc anh em 8386, tài lộc ập đến! 💰",
	"Nhóm mình mãi dỉnh, mãi keo, mãi mận! 🤞",
	"Chúc cả hội tiền tài 9999, tình duyên 10 điểm! 💎",
	"Năm mới 1 vốn 4 lời, đánh đâu thắng đó! 🎯",
	"Chúc cả team 6868, lộc phát lộc phát! 🚀",
];
